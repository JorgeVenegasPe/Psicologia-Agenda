...
<div class="containerTotal">
    ...
    <div class="recent-orders" style="flex-direction:row;">
     ...
     <button type="submit" style="padding:10px;  background-color:beige"><span><a href="citas.php">Agregar cita</a></span></button>
     <button type="submit" style="padding:10px;  background-color:azure"><span><a href="">Buscar cita</a></span></button>
    </div>
