              ...
              <div style="display:flex; flex-direction:row; gap:70px;">
                <div class="checkout-information">
                  ...
                  <div class="input-group">
                    ...
                    <input id="NomMadre" type="text" name="NomMadre" class="input"
                      placeholder="Aqui tu Nombre de la Madre" required />
                  </div>
                  <div class="input-group">
                    <h3 for="EstadoMadre">Estado de la Madre</h3>
                    <input id="EstadoMadre" type="text" name="EstadoMadre" class="input"
                      placeholder="Aqui tu Nombre de la Madre" required />
                  </div>
                  <div class="input-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" id="EstadoPadre" name="EstadoPadre" placeholder="Aqui tu Nombre del Padre"
                      required />
                  </div>
                  <div class="input-group">
                    <h3 for="NomApoderado">Nombre del Apoderado</h3>
                    <input type="text" id="NomApoderado" name="NomApoderado" placeholder="Aqui tu Nombre del Padre"
                      required />
                  </div>
                  <div class="input-group">
                    <h3 for="EstadoApoderado">Estado de la Apoderado</h3>
                    <input type="text" id="EstadoApoderado" name="EstadoApoderado" placeholder="Aqui tu Nombre del Padre"
                      required />
                  </div>
                </div>
                ...
                <div class="checkout-information">
                  <div class="input-group2" style=" width:310px">
                    <div class="input-group" style="flex-direction: column;">
                      ...
                      <div style="display: flex;gap:6px;">
                        <input id="CantHijos" style="width: 50%;" type="number" name="CantHijos" class="input" min="0"
                    ...
                    <div class="input-group" style="flex-direction: column;">
                      ...
                      <div style="display: flex; gap:5px;">
                        <input id="CantHermanos" style="width: 60%;" type="number" name="CantHermanos" class="input"
                  ...
                  <div class="input-group">
                    ...
                    <textarea style="resize: none; padding: 1.8em 1em;font-family: 'Poppins', sans-serif;font-size: 14px;"
                      type="text" id="IntegracionFamiliar" name="IntegracionFamiliar" placeholder="Integracion Familiar"
                      required></textarea>
                  </div>
                  <div class="input-group">
                    <h3 for="HistorialFamiliar">Historial Familiar</h3>
                    <textarea style="resize: none; padding: 1.8em 1em;font-family: 'Poppins', sans-serif;font-size: 14px;"
                      type="text" id="HistorialFamiliar" name="HistorialFamiliar" placeholder="Historial Marital"
                      required></textarea>
                  </div>
                </div>
              </div>
