...
<style>
    .container-paciente-tabla{
        display: grid;
        grid-template-columns: repeat(auto-fit, minmax(28rem, 4fr));
        gap: 1rem;
    }
                            ...
                            <div class="containerModalEliminar">
                                ...
                                <form class="form" style="margin-top: -10px;" autocomplete="off" method="post">
                                    ...
                                    <div class="input-group">
                                        <div>
                                            <br>
                                            <a class="ButtonEliminar" style="margin-left: 18em;" href="../Crud/Paciente/eliminarPaciente.php?id=<?= $row[0] ?>">Eliminar</a>
                                        </div>
                                    </div>
                                    <br>
                                </form>
