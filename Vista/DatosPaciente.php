  ...
  <main class="animate_animated animate_fadeIn">
    ...
    <div class="recent-updates" style="display:flex; flex-direction: row; gap:20px; align-items: center; padding: 10px 0px 0px 10px">
        ...
        <a class="button" href="RegPaciente.php">
            <p style="padding: 12px 13px 12px 20px; color:#49c691;" >Agregar Paciente</p>
            <div class="blue">
    ...
    <div class="container-paciente-tabla">    
        ...
        <div class="details" style="display: flex; flex-direction:row; margin-left:0px; margin-top:-40px;">
            <div class="line"></div>
                    ...
                    <div class="datitos">
                        ...
                        <div class="BUT">
                            <button type="button" id="button2">
                                <a href="AtenPaciente.php" style="color:white;"> Nueva Entrada</a> 
                            </button>
                        </div>
                    </div>
